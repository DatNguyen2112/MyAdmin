          ...
          .then((url) => {
            db.collection("Products")
              ...
              .then(() => {
                ...
                setCategorysFashion("");
                setTimeout(() => {
                  toast.success(`Bạn vừa đăng một tin mới`);
                }, 1000);
      ...
      <div className="addProducts">
        ...
        <div className="addProducts_container">
          <div className="SignIn__title">
            <h3 className="SignIn__text">Thêm sản phẩm</h3>
          </div>
            ...
            <form onSubmit={handleAddProducts} action="">
                    ...
                    return (
                      <div key={sex.id}>
                        <input
                          value={checked}
                          type="radio"
                          checked={checked === sex.Sex}
                          onChange={() => setChecked(sex.Sex)}
                        />
                        <label
                    ...
                    return (
                      <div key={size.id}>
                        <input
                          value={check}
                          type="radio"
                          checked={check === size.Size}
                          onChange={() => setCheck(size.Size)}
                        />
                        <label
                          style={{ paddingLeft: 10 }}
                          className="OwnOFY__user-title"
              ...
              {categorys === "Áo" && (
                <div className="OwnOFY__user">
                  ...
                  <select
                    value={categorysItem}
                    onChange={(e) => setCategorysItem(e.target.value)}
                    className="OwnOFY__user-input"
                  >
                    <option value="">Lựa chọn danh mục</option>
              ...
              <div className="OwnOFY__user">
                ...
                <select
                  value={categorysFashion}
                  onChange={(e) => setCategorysFashion(e.target.value)}
                  className="OwnOFY__user-input"
                >
